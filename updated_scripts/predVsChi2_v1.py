...
trimAhcal_chi2Reco = np.asarray(pickle.load(open("./aggre2_maxlr6e04_75ep/constlr_2feat/tb_data/pred_tb.pickle","rb"))) #tree['trimAhcal_chi2Reco'].array()
...
fout= ROOT.TFile("hist_predicVsEnrgyinAbsorber_TB_2vs4input_2aggre_constlr_trimAhcal.root", 'RECREATE')
fout.cd()
