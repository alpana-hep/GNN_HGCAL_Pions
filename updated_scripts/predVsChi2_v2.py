...
pred_v2 ="./aggre2_maxlr6e04_75ep/constlr_2feat/tb_data/pred_tb.pickle"
...
fout= ROOT.TFile("hist_predicVsEnrgyinAbsorber_TB_2vs1input_2aggre_constlr_trimAhcal.root", 'RECREATE')
fout.cd()
