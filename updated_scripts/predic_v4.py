...
import pickle
import numpy as np
pred_v2 ="./aggre2_maxlr6e04_75ep/constlr_1feat/valid_flat/pred_tb.pickle"
...
tb_pred_v2 ="./aggre2_maxlr6e04_75ep/constlr_1feat/tb_data_upscaled/pred_tb.pickle"
...
RechitEn_tb ="/home/rusack/shared/pickles/HGCAL_TestBeam/pkl_files/pkl_upscaled_TB_fixwtuptriwt_1feat/recHitEn.pickle"
...
import ROOT
fout= ROOT.TFile("./aggre2_maxlr6e04_75ep/constlr_1feat/hist_upscaledTB_8beamE_uprelwt_constlr_maxlr1e04_2aggre_ep95_1feat_NSM.root", 'RECREATE')
import ROOT
hist_pred_Valid=[]
hist_true_Valid=[]
hist_pred_Train=[]
