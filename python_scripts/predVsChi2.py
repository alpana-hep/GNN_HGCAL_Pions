...
print(len(predic))
RechitEn ="/home/rusack/shared/pickles/HGCAL_TestBeam/Test_alps/tb_data/fix_wt/recHitEn.pickle"
...
fout= ROOT.TFile("hist_predicVsEnrgyinAbsorber_SSlocation_trimAhcal_92epochs_data.root", 'RECREATE')
fout.cd()
...
for i in range(len(trueEn_pkl)):
    ...
    h2d_chi2vs_model.Fill(Pred_[i],trimAhcal_chi2Reco[i])
