...
tb_valid_idx_file="/home/rusack/shared/pickles/HGCAL_TestBeam/Test_alps/tb_data/tb_corrAlign/all_valididx.pickle"
tb_train_idx_file="/home/rusack/shared/pickles/HGCAL_TestBeam/Test_alps/tb_data/tb_corrAlign/all_trainidx.pickle"
tb_pred_v2 ="./tb_alignCorr/pred_tb.pickle"
...
tb_trueEn= "/home/rusack/shared/pickles/HGCAL_TestBeam/Test_alps/tb_data/tb_corrAlign/beamEn.pickle"
tb_trueEnPickle = open(tb_trueEn,"rb")
tb_trueEn_pkl = np.asarray(pickle.load(tb_trueEnPickle))
print(tb_trueEn_pkl[200000])
RechitEn_tb ="/home/rusack/shared/pickles/HGCAL_TestBeam/Test_alps/tb_data/tb_corrAlign/recHitEn.pickle"
RechitEn_tbPickle = open(RechitEn_tb,"rb")
RechitEn_tb_pkl =pickle.load(RechitEn_tbPickle)
tbhit_z ="/home/rusack/shared/pickles/HGCAL_TestBeam/Test_alps/tb_data/tb_corrAlign/Hit_Z.pickle"
...
import ROOT
fout= ROOT.TFile("hist_ratio_fixwt_lr1e04_beamE_5M_100epoch_TBAlignCorr.root", 'RECREATE')
import ROOT
hist_pred_Valid=[]
hist_true_Valid=[]
hist_pred_Train=[]
