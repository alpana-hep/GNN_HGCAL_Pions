...
tb_valid_idx_file="/home/rusack/shared/pickles/HGCAL_TestBeam/test_tb_fix_raw_ahcalTrim/all_valididx.pickle"
tb_train_idx_file="/home/rusack/shared/pickles/HGCAL_TestBeam/test_tb_fix_raw_ahcalTrim/all_trainidx.pickle"
...
RechitEn_tb ="/home/rusack/shared/pickles/HGCAL_TestBeam/Test_alps/tb_data/tb_corrAlign/trim_Ahcal/recHitEn.pickle"
RechitEn_tbPickle = open(RechitEn_tb,"rb")
RechitEn_tb_pkl =pickle.load(RechitEn_tbPickle)
tbhit_z ="/home/rusack/shared/pickles/HGCAL_TestBeam/test_tb_fix_raw_ahcalTrim/Hit_Z.pickle"
...
rawE_tb = ak.sum(RechitEn_tb_pkl*frac, axis=1)
...
import ROOT
fout= ROOT.TFile("hist_ratio_beamE_5M_DownScaledAHCAL_92ep_upscaletB.root", 'RECREATE')
import ROOT
hist_pred_Valid=[]
hist_true_Valid=[]
hist_pred_Train=[]
